...
public final class C0431n extends AbstractC0418a implements Serializable {

    /* renamed from: o */
    public static final C0431n f149837o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d */
    private final transient String f149838d = "Hijrah-umalqura";

    /* renamed from: e */
    private final transient String f149839e = "islamic-umalqura";

    /* renamed from: f */
    private volatile transient boolean f149840f;

    /* renamed from: g */
    private transient int[] f149841g;

    /* renamed from: h */
    private transient int f149842h;

    /* renamed from: i */
    private transient int f149843i;

    /* renamed from: j */
    private transient int f149844j;

    /* renamed from: k */
    private transient int f149845k;

    /* renamed from: l */
    private transient int f149846l;

    /* renamed from: m */
    private transient int f149847m;

    /* renamed from: n */
    private transient int f149848n;

    static {
        C0431n c0431n = new C0431n();
        f149837o = c0431n;
        AbstractC0418a.m58954t(c0431n, "Hijrah");
        AbstractC0418a.m58954t(c0431n, "islamic");
    }
    ...
    /* renamed from: V */
    private void m58991V() {
        if (!this.f149840f) {
            String str = this.f149838d;
            try {
                HashMap hashMap = new HashMap();
                int[][] m58994e0 = m58994e0();
                int mo58810w = (int) LocalDate.m58788of(1882, 11, 12).mo58810w();
                for (int i = 1300; i <= 1600; i++) {
                    int[] iArr = m58994e0[i - 1300];
                    if (iArr.length == 12) {
                ...
                if (str.equals("Hijrah-umalqura")) {
                    if (this.f149839e.equals("islamic-umalqura")) {
                        if (mo58810w != 0) {
                            this.f149844j = 15600;
                            this.f149842h = mo58810w;
                            int[] m58992X = m58992X(mo58810w, hashMap);
                            this.f149841g = m58992X;
                            this.f149843i = m58992X[3612];
                            for (int i2 = 1300; i2 < 1600; i2++) {
                                int m58995f0 = m58995f0(i2, 12);
                                this.f149847m = Math.min(this.f149847m, m58995f0);
                                this.f149848n = Math.max(this.f149848n, m58995f0);
                            }
                            this.f149840f = true;
                            return;
                        }
    ...
    /* renamed from: X */
    private int[] m58992X(int i, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.f149845k = Integer.MAX_VALUE;
        this.f149846l = Integer.MIN_VALUE;
        int i2 = 0;
        for (int i3 = 1300; i3 <= 1600; i3++) {
            ...
            while (i4 < 12) {
                ...
                if (i5 >= 29 && i5 <= 32) {
                    i += i5;
                    this.f149845k = Math.min(this.f149845k, i5);
                    this.f149846l = Math.max(this.f149846l, i5);
                    i4++;
                    i2 = i6;
                } else {
    ...
    /* renamed from: Y */
    private int m58993Y(int i) {
        return (i + this.f149844j) / 12;
    }

    /* renamed from: e0 */
    private static int[][] m58994e0() {
    ...
    /* renamed from: f0 */
    private int m58995f0(int i, int i2) {
        int i3 = (i * 12) - this.f149844j;
        int[] iArr = this.f149841g;
    ...
    public final ChronoLocalDate mo58935I(int i, int i2, int i3) {
        return C0433p.m59003Z(this, i, i2, i3);
    }
    ...
    public final ChronoLocalDate mo58936L(Map map, EnumC0452F enumC0452F) {
        return (C0433p) super.mo58936L(map, enumC0452F);
    }
    ...
    public final C0508o mo58937M(EnumC0494a enumC0494a) {
        m58991V();
        if (enumC0494a instanceof EnumC0494a) {
            switch (AbstractC0430m.f149836a[enumC0494a.ordinal()]) {
                case 1:
                    return C0508o.m59175k(1L, this.f149845k, this.f149846l);
                case 2:
                    return C0508o.m59174j(1L, this.f149848n);
                case 3:
                    return C0508o.m59174j(1L, 5L);
                case 4:
                case 5:
                    return C0508o.m59174j(m58993Y(0), m58993Y(this.f149841g.length - 1) - 1);
                case 6:
    ...
    public final List mo58939P() {
        return AbstractC0314g.m58409b(EnumC0434q.values());
    }
    ...
    public final boolean mo58940R(long j) {
        m58991V();
        if (j < m58993Y(0) || j > m58993Y(this.f149841g.length - 1) - 1 || m58995f0((int) j, 12) <= 354) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: W */
    public final int m58996W(long j) {
        if (j >= m58993Y(0) && j <= m58993Y(this.f149841g.length - 1) - 1) {
            return (int) j;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: Z */
    public final int m58997Z(int i, int i2) {
        return m58995f0(i, i2 - 1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a0 */
    public final long m58998a0(int i, int i2, int i3) {
        m58991V();
        if (i2 >= 1 && i2 <= 12) {
            int i4 = (i2 - 1) + ((i * 12) - this.f149844j);
            if (i4 >= 0 && i4 < this.f149841g.length) {
                if (i3 >= 1 && i3 <= m59000c0(i, i2)) {
                    return (i3 - 1) + this.f149841g[i4];
                }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: b0 */
    public final int[] m58999b0(int i) {
        m58991V();
        if (i >= this.f149842h && i < this.f149843i) {
            int binarySearch = Arrays.binarySearch(this.f149841g, i);
            if (binarySearch < 0) {
                binarySearch = (-binarySearch) - 2;
            }
            return new int[]{m58993Y(binarySearch), ((this.f149844j + binarySearch) % 12) + 1, (i - this.f149841g[binarySearch]) + 1};
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: c0 */
    public final int m59000c0(int i, int i2) {
        int i3 = (i2 - 1) + ((i * 12) - this.f149844j);
        if (i3 >= 0) {
            int[] iArr = this.f149841g;
            if (i3 < iArr.length) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: d0 */
    public final int m59001d0(int i) {
        return m58995f0(i, 12);
    }

    @Override // p047j$.time.chrono.InterfaceC0428k
    public final String getId() {
        return this.f149838d;
    }

    @Override // p047j$.time.chrono.InterfaceC0428k
    /* renamed from: h */
    public final int mo58942h(InterfaceC0429l interfaceC0429l, int i) {
        if (interfaceC0429l instanceof EnumC0434q) {
            return i;
        }
    ...
    public final ChronoLocalDate mo58943l(long j) {
        return C0433p.m59004a0(this, j);
    }

    @Override // p047j$.time.chrono.AbstractC0418a
    /* renamed from: p */
    public final ChronoLocalDate mo58944p() {
        return C0433p.m59004a0(this, LocalDate.m58783d0(AbstractC0407b.m58928c()).getLong(EnumC0494a.EPOCH_DAY));
    }

    @Override // p047j$.time.chrono.InterfaceC0428k
    /* renamed from: q */
    public final ChronoLocalDate mo58945q(TemporalAccessor temporalAccessor) {
        if (temporalAccessor instanceof C0433p) {
            return (C0433p) temporalAccessor;
        }
        return C0433p.m59004a0(this, temporalAccessor.getLong(EnumC0494a.EPOCH_DAY));
    }

    @Override // p047j$.time.chrono.InterfaceC0428k
    /* renamed from: v */
    public final String mo58946v() {
        return this.f149839e;
    }
    ...
    public final ChronoLocalDate mo58947x(int i, int i2) {
        C0433p m59003Z = C0433p.m59003Z(this, i, 1, 1);
        if (i2 <= m59003Z.mo58793Q()) {
            return m59003Z.mo58931V(i2 - 1);
        }
