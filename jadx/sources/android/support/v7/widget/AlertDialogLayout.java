...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: a */
    private static int m22962a(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m22962a(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L37:
            ...
            int r12 = r3 + r14
        L41:
            android.graphics.drawable.Drawable r14 = r9.f47621g
            r0 = 0
            if (r14 != 0) goto L48
            r14 = r0
            goto L4c
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i13 = 0; i13 < childCount; i13++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (c0901mf.width == -1) {
                        int i14 = c0901mf.height;
                        c0901mf.height = childAt3.getMeasuredHeight();
