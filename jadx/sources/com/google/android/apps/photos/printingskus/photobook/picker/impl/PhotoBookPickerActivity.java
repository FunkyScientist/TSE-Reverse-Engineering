...
public final class PhotoBookPickerActivity extends yff implements aybb, rxo {

    /* renamed from: p */
    private final aheo f127699p;

    /* renamed from: q */
    private final ahnn f127700q;

    public PhotoBookPickerActivity() {
        aheo aheoVar = new aheo(this, this.f76602K);
        aheoVar.m17858i(this.f189768H);
        this.f127699p = aheoVar;
        ahnp ahnpVar = new ahnp(this, 2);
        this.f127700q = ahnpVar;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.f127699p.m17857h(bundle);
        if (bundle == null) {
            this.f127699p.m17853d();
