...
public final class SuggestedVideoHdrProvider$VideoHdrSuggestedActionData implements SuggestedActionData {
    public static final Parcelable.Creator CREATOR = new aotb(14);

    /* renamed from: a */
    private final SuggestedAction f129107a;

    public SuggestedVideoHdrProvider$VideoHdrSuggestedActionData(Parcel parcel) {
        this.f129107a = (SuggestedAction) parcel.readParcelable(SuggestedAction.class.getClassLoader());
    }
    ...
    public final awxp mo48461h(awxs awxsVar) {
        return new aykk(awxsVar, aoti.VIDEO_HDR.f53058K, this.f129107a.f129090e.m24895b());
    }
