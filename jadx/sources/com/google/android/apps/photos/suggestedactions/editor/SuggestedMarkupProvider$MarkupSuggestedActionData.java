...
public final class SuggestedMarkupProvider$MarkupSuggestedActionData implements SuggestedActionData {
    public static final Parcelable.Creator CREATOR = new aotb(11);

    /* renamed from: a */
    public final SuggestedAction f129103a;

    public SuggestedMarkupProvider$MarkupSuggestedActionData(Parcel parcel) {
        this.f129103a = (SuggestedAction) parcel.readParcelable(SuggestedAction.class.getClassLoader());
    }
    ...
    public final Drawable mo48454a(Context context) {
        return C0927ne.m63704o(context, R.drawable.photos_quantum_gm_ic_gesture_vd_theme_18);
    }
    ...
    public final /* bridge */ /* synthetic */ List mo48459f(Context context) {
        return batz.m37362l(context.getString(R.string.photos_suggestedactions_editor_markup));
    }
    ...
    public final awxp mo48461h(awxs awxsVar) {
        return new aykk(awxsVar, aoti.MARKUP.f53058K, this.f129103a.f129090e.m24895b());
    }
