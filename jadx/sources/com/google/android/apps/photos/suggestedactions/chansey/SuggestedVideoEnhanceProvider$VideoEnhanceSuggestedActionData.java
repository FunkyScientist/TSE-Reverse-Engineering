...
public final class SuggestedVideoEnhanceProvider$VideoEnhanceSuggestedActionData implements SuggestedActionData {
    public static final Parcelable.Creator CREATOR = new aotb(5);

    /* renamed from: a */
    private final SuggestedAction f129093a;

    public SuggestedVideoEnhanceProvider$VideoEnhanceSuggestedActionData(SuggestedAction suggestedAction) {
        suggestedAction.getClass();
        this.f129093a = suggestedAction;
    }
    ...
    public final Drawable mo48454a(Context context) {
        context.getClass();
        return C0927ne.m63704o(context, R.drawable.photos_quantum_gm_ic_edit_fix_auto_vd_theme_18);
    }
    ...
    public final List mo48459f(Context context) {
        context.getClass();
        return bkcw.m44260N(context.getString(R.string.photos_photoeditor_suggestedactions_video_editor_video_enhance));
    }
    ...
    public final awxp mo48461h(awxs awxsVar) {
        return new aykk(awxsVar, aoti.CHANSEY.f53058K, this.f129093a.f129090e.m24895b());
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.getClass();
        parcel.writeParcelable(this.f129093a, i);
    }
}
