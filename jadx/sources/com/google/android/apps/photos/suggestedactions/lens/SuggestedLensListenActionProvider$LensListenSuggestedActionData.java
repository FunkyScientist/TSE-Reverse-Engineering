...
public final class SuggestedLensListenActionProvider$LensListenSuggestedActionData implements SuggestedActionData {
    public static final Parcelable.Creator CREATOR = new aows(7);

    /* renamed from: a */
    public final SuggestedAction f129118a;

    public SuggestedLensListenActionProvider$LensListenSuggestedActionData(Parcel parcel) {
        this.f129118a = (SuggestedAction) parcel.readParcelable(SuggestedAction.class.getClassLoader());
    }
    ...
    public final Drawable mo48454a(Context context) {
        return C0927ne.m63704o(context, R.drawable.photos_quantum_gm_ic_record_voice_over_vd_theme_18);
    }
    ...
    public final List mo48459f(Context context) {
        return batz.m37362l(context.getString(R.string.photos_suggestedactions_lens_listen));
    }
    ...
    public final awxp mo48461h(awxs awxsVar) {
        return new aykk(awxsVar, aoti.LENS_LISTEN.f53058K, this.f129118a.f129090e.m24895b());
    }
