...
public final class MapExploreDeepLinkGatewayActivity extends yff {

    /* renamed from: p */
    private final yrn f125758p;

    public MapExploreDeepLinkGatewayActivity() {
        yrn yrnVar = new yrn(this.f76602K);
        yrnVar.mo32666j(new osu(this, 15));
        yrnVar.m73367r(this.f189768H);
        this.f125758p = yrnVar;
    }
    ...
    /* renamed from: y */
    public final void m47383y(Intent intent) {
