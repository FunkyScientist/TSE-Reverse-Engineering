...
public class MapEnrichmentLayout extends FrameLayout implements yie, yid, mgk {

    /* renamed from: a */
    private mgj f123472a;
    ...
    public final PointF mo46623c() {
        RectF m63049b = this.f123472a.m63049b();
    ...
    protected final void onAttachedToWindow() {
        ...
        this.f123472a.f159339e = (View) getParent();
    }

    @Override // android.view.ViewGroup, android.view.View
    protected final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f123472a.f159339e = null;
    }

    @Override // android.view.View
    protected final void onFinishInflate() {
        this.f123472a = new mgj(this, false);
    }
}
