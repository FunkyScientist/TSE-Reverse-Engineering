...
public final class LocationEnrichmentLayout extends FrameLayout implements yie, yid, mgk {

    /* renamed from: a */
    private mgj f123471a;
    ...
    public final PointF mo46623c() {
        RectF m63049b = this.f123471a.m63049b();
    ...
    protected final void onAttachedToWindow() {
        ...
        this.f123471a.f159339e = (View) getParent();
    }

    @Override // android.view.ViewGroup, android.view.View
    protected final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f123471a.f159339e = null;
    }

    @Override // android.view.View
    protected final void onFinishInflate() {
        this.f123471a = new mgj(this);
    }
}
