...
public final class PhotosAboutSettingsActivityV2 extends yff {
    public PhotosAboutSettingsActivityV2() {
        ...
        new awxj(bcub.f88697c).m32789b(this.f189768H);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            c0070ba.m50534o(R.id.main_settings_fragment, new alvm());
            c0070ba.mo36567a();
        }
    }
}
