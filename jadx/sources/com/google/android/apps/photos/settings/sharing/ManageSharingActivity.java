...
public final class ManageSharingActivity extends yff {
    public ManageSharingActivity() {
        new aylm(this, this.f76602K);
        new oaa(this.f76602K);
        new muw().m63542a(this, this.f76602K).m62590h(this.f189768H);
        new awxj(bcuc.f88761aN).m32789b(this.f189768H);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            c0070ba.m50534o(R.id.main_settings_fragment, new amas());
            c0070ba.mo36567a();
        }
    }
}
