...
public final class jyv {
    ...
    /* renamed from: a */
    public static final jyv f153180a = jtj.m60331ad(new LinkedHashMap());

    /* renamed from: b */
    public final Map f153181b;

    public jyv(jyv jyvVar) {
        jyvVar.getClass();
        this.f153181b = new HashMap(jyvVar.f153181b);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: b */
    public static final jyv m60548b(byte[] bArr) {
        boolean z;
        Object obj;
        bArr.getClass();
                ...
                if (z) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            bkgo.m44726x(objectInputStream, th);
                            throw th2;
                        }
                    }
                } else {
                    ...
                    try {
                        ...
                        if (readShort == -21521) {
                            ...
                            if (readShort2 == 1) {
                                ...
                                for (int i2 = 0; i2 < readInt2; i2++) {
                                    ...
                                    if (readByte == 0) {
                                        ...
                                        for (int i9 = 0; i9 < readInt9; i9++) {
                                            ...
                                            if (true == C1131ut.m70384u(readUTF2, "androidx.work.Data-95ed6082-b8e9-46e8-a73f-ff56f00f5d9d")) {
                                                readUTF2 = null;
                                            }
                                            strArr[i9] = readUTF2;
                                        }
                                        ...
                                        throw new IllegalStateException(C0069b.m36491bG(readByte, "Unsupported type "));
                                    }
                                ...
                                throw new IllegalStateException(C0069b.m36491bG(readShort2, "Unsupported version number: "));
                            }
                        } else {
                            throw new IllegalStateException(C0069b.m36491bG(readShort, "Magic number doesn't match: "));
                        }
                    } catch (Throwable th3) {
                        try {
                            throw th3;
                        } catch (Throwable th4) {
                            bkgo.m44726x(dataInputStream, th3);
                            throw th4;
                        }
                    }
                }
            } catch (IOException unused) {
                int i10 = jyw.f153182a;
                jzi.m60565a();
            } catch (ClassNotFoundException unused2) {
                int i11 = jyw.f153182a;
                jzi.m60565a();
            }
            return new jyv(linkedHashMap);
        }
        throw new IllegalStateException("Data cannot occupy more than 10240 bytes when serialized");
    }

    /* renamed from: a */
    public final int m60549a(String str, int i) {
        Map map = this.f153181b;
    ...
    /* renamed from: c */
    public final String m60550c(String str) {
        Object obj = this.f153181b.get(str);
    ...
    /* renamed from: d */
    public final boolean m60551d(String str, Class cls) {
        Object obj = this.f153181b.get(str);
    ...
    /* renamed from: e */
    public final byte[] m60552e(String str) {
        Object obj = this.f153181b.get(str);
        ...
        jyu jyuVar = new jyu(obj, 0);
        byte[] bArr = new byte[length];
        for (int i = 0; i < length; i++) {
            bArr[i] = ((Number) jyuVar.mo9836a(Integer.valueOf(i))).byteValue();
        }
        return bArr;
    }
    ...
    */
    public final boolean equals(java.lang.Object r8) {
        ...
        L16:
            jyv r8 = (p000.jyv) r8
            java.util.Map r2 = r7.f153181b
            java.util.Map r3 = r8.f153181b
            java.util.Set r2 = r2.keySet()
            java.util.Set r3 = r3.keySet()
            boolean r3 = p000.C1131ut.m70384u(r2, r3)
            if (r3 != 0) goto L2b
            return r1
        L2b:
        ...
        L2f:
            ...
            java.util.Map r4 = r7.f153181b
            java.lang.Object r4 = r4.get(r3)
            java.util.Map r5 = r8.f153181b
        ...
        L4c:
            ...
            boolean r3 = p000.bjwl.m44312am(r5, r3)
            goto L62
        L5e:
            boolean r3 = p000.C1131ut.m70384u(r4, r3)
        L62:
            if (r3 != 0) goto L2f
            goto L67
        L65:
        ...
        L69:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.jyv.equals(java.lang.Object):boolean");
    }

    /* renamed from: f */
    public final boolean m60553f(String str) {
        Object obj = false;
        Object obj2 = this.f153181b.get(str);
    ...
    public final int hashCode() {
        int hashCode;
        int i = 0;
        for (Map.Entry entry : this.f153181b.entrySet()) {
    ...
    public final String toString() {
        return "Data {" + bkcw.m44589bS(this.f153181b.entrySet(), null, null, null, C1028qy.f171872u, 31) + "}";
    }

    public jyv(Map map) {
        this.f153181b = new HashMap(map);
    }
}
