...
public class akol extends yff implements biao {

    /* renamed from: q */
    private biai f39958q;

    /* renamed from: r */
    private volatile bhzt f39959r;

    /* renamed from: s */
    private final Object f39960s = new Object();

    /* renamed from: p */
    public boolean f39957p = false;

    public akol() {
        m66576jN(new C0197fc((ActivityC0198fd) this, 12));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getApplication() instanceof bian) {
            ...
            this.f39958q = m40965a;
            if (m40965a.m40974a()) {
                this.f39958q.f109784a = mo36704V();
            }
        }
    }
    ...
    public final bhzt mo20378b() {
        if (this.f39959r == null) {
            synchronized (this.f39960s) {
                if (this.f39959r == null) {
                    this.f39959r = new bhzt(this);
                }
            }
        }
        return this.f39959r;
