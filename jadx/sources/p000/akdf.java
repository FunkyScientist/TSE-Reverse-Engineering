...
public class akdf extends yff implements biao {

    /* renamed from: q */
    private biai f38667q;

    /* renamed from: r */
    private volatile bhzt f38668r;

    /* renamed from: s */
    private final Object f38669s = new Object();

    /* renamed from: p */
    public boolean f38666p = false;

    public akdf() {
        m66576jN(new C0197fc((ActivityC0198fd) this, 9));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getApplication() instanceof bian) {
            ...
            this.f38667q = m40965a;
            if (m40965a.m40974a()) {
                this.f38667q.f109784a = mo36704V();
            }
        }
    }
    ...
    public final bhzt mo20378b() {
        if (this.f38668r == null) {
            synchronized (this.f38669s) {
                if (this.f38668r == null) {
                    this.f38668r = new bhzt(this);
                }
            }
        }
        return this.f38668r;
