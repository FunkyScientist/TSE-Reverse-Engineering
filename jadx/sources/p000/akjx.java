...
public class akjx extends yfh implements biao {

    /* renamed from: a */
    private ContextWrapper f39451a;

    /* renamed from: b */
    private boolean f39452b;

    /* renamed from: c */
    private volatile biac f39453c;

    /* renamed from: d */
    private final Object f39454d = new Object();

    /* renamed from: e */
    private boolean f39455e = false;

    /* renamed from: a */
    private final void m20546a() {
        if (this.f39451a == null) {
            this.f39451a = new biaj(this.f189783bc, this);
            this.f39452b = bhpa.m40660f(this.f189783bc);
        }
    }
    ...
    public final void mo20382al(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f39451a;
        boolean z = true;
    ...
    public final Context mo20384gv() {
        if (this.f189783bc == null && !this.f39452b) {
            return null;
        }
        m20546a();
        return this.f39451a;
    ...
    public final biac mo20378b() {
        if (this.f39453c == null) {
            synchronized (this.f39454d) {
                if (this.f39453c == null) {
                    this.f39453c = new biac(this);
                }
            }
        }
        return this.f39453c;
    ...
    /* renamed from: u */
    protected final void m20548u() {
        if (!this.f39455e) {
            this.f39455e = true;
            ((akjo) this).f39405f = (AccountId) ((lqj) mo20379c()).f157714c.mo9953b();
        }
    }
}
