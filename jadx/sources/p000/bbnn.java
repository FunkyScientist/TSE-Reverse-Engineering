...
public enum bbnn implements bfit {
    ...
    /* renamed from: b */
    public static bbnn m38129b(int i) {
        switch (i) {
            case 0:
            ...
            case Filter.PRIORITY_NORMAL /* 50 */:
                return HARDWARE_VOLUME_BUTTON_PRESS;
            case 51:
                return CAST_SDK_DEFAULT_DEVICE_DIALOG;
            case 52:
                return CAST_SDK_CUSTOM_DEVICE_DIALOG;
            case 53:
                return PERSISTENT_CAST_BUTTON_DISCOVERY_DISABLED_WITH_CONFLICT_TYPES;
            case 54:
                return CAST_DEVICE_DIALOG_FACTORY_INSTANTIATED;
            case 55:
                return CAF_MEDIA_NOTIFICATION_PROXY;
            case 56:
                return REMOTE_CONNECTION_MANAGER_ACQUIRED;
            case 57:
                return REMOTE_CONNECTION_CALLBACK_SET;
            default:
                return null;
        }
    }
    ...
    public final int mo6948a() {
        return this.f82779ag;
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.toString(this.f82779ag);
    }
}
