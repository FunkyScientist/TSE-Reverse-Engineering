...
public final class ahwy implements aios {

    /* renamed from: a */
    private static final ContentId f31087a = new AutoValue_ContentId(ahia.KIOSK_PRINTS, ainl.ORDER);

    /* renamed from: b */
    private final Context f31088b;

    /* renamed from: c */
    private final aiok f31089c;

    public ahwy(Context context) {
        this.f31088b = context;
        this.f31089c = new aipd(context);
    }
    ...
    public final Uri mo18532d(int i) {
        return _2001.m3201q(2, i, ahia.KIOSK_PRINTS);
    }
    ...
    public final aioo mo18535g(ComponentCallbacksC0094by componentCallbacksC0094by, aypb aypbVar) {
        return new ainx(aypbVar, f31087a);
    }
    ...
    public final List mo18537i(int i, boolean z, int i2, ahsn ahsnVar) {
        batz m3427b = ((_2112) aylw.m34567e(this.f31088b, _2112.class)).m3427b(ahia.KIOSK_PRINTS, i, i2);
        ArrayList arrayList = new ArrayList(((bbbl) m3427b).f81877c);
        arrayList.addAll(new ains(this.f31088b, i, new ahwx(this.f31088b, 0)).mo9346a(m3427b));
        return arrayList;
    }
}
