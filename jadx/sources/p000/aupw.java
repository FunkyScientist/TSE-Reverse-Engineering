...
public final class aupw implements aupz {

    /* renamed from: a */
    private final Throwable f67401a;

    public aupw(Throwable th) {
        this.f67401a = th;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof aupw) && C1131ut.m70384u(this.f67401a, ((aupw) obj).f67401a)) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "GenericHttpPermanentFailure(exception=" + this.f67401a + ")";
    }
}
