...
public final class aihy implements aios {

    /* renamed from: a */
    private static final ContentId f32226a = new AutoValue_ContentId(ahia.PRINT_SUBSCRIPTION, ainl.ORDER);

    /* renamed from: b */
    private final Context f32227b;

    /* renamed from: c */
    private final aiok f32228c;

    public aihy(Context context) {
        this.f32227b = context;
        this.f32228c = new aipd(context);
    }
    ...
    public final Uri mo18532d(int i) {
        return _2001.m3201q(2, i, ahia.PRINT_SUBSCRIPTION);
    }
    ...
    public final aioo mo18535g(ComponentCallbacksC0094by componentCallbacksC0094by, aypb aypbVar) {
        return new ainx(aypbVar, f32226a);
    }
    ...
    public final List mo18537i(int i, boolean z, int i2, ahsn ahsnVar) {
        batz m3427b = ((_2112) aylw.m34567e(this.f32227b, _2112.class)).m3427b(ahia.PRINT_SUBSCRIPTION, i, i2);
        ArrayList arrayList = new ArrayList(((bbbl) m3427b).f81877c);
        arrayList.addAll(new ains(this.f32227b, i, new ahwx(this.f32227b, 3, (short[]) null)).mo9346a(m3427b));
        return arrayList;
    }
}
