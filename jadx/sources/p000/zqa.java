...
final class zqa extends awnr {
    ...
    public final View mo20892a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        ((TextView) inflate.findViewById(R.id.section_header_text)).setText(R.string.photos_mediadetails_people_facetag_recent_clusters);
        return inflate;
    }
}
