...
final class eag extends eah {
    public eag(eaq eaqVar) {
        super(eaqVar);
    }
    ...
    public final boolean contains(Object obj) {
        return this.f137311a.containsKey(obj);
    }
    ...
    public final boolean containsAll(Collection collection) {
        ...
        while (it.hasNext()) {
            if (!this.f137311a.containsKey(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public final /* bridge */ /* synthetic */ Iterator iterator() {
        return new ebd(this.f137311a, this.f137311a.m51411c().f137320a.entrySet().iterator());
    }

    @Override // java.util.Set, java.util.Collection
    public final boolean remove(Object obj) {
        if (this.f137311a.remove(obj) != null) {
            return true;
        }
        return false;
    }
    ...
    public final boolean removeAll(Collection collection) {
        ...
        while (true) {
            boolean z = false;
            while (it.hasNext()) {
                if (this.f137311a.remove(it.next()) != null || z) {
                    z = true;
                }
            }
            return z;
    ...
    public final boolean retainAll(Collection collection) {
        ...
        do {
            ...
            for (Map.Entry entry : set) {
                if (!m44582bL.contains(entry.getKey())) {
