...
public final class C0915mt extends AbstractC0916mu {
    public C0915mt(AbstractC0935nm abstractC0935nm) {
    ...
    public final int mo63435a(View view) {
        return this.f161089a.mo63852au(view) + ((C0936nn) view.getLayoutParams()).bottomMargin;
    }
    ...
    public final int mo63438d(View view) {
        return this.f161089a.mo63832aA(view) - ((C0936nn) view.getLayoutParams()).topMargin;
    }

    @Override // p000.AbstractC0916mu
    /* renamed from: e */
    public final int mo63439e() {
        return this.f161089a.f162613E;
    }
    ...
    public final int mo63440f() {
        ...
        return abstractC0935nm.f162613E - abstractC0935nm.getPaddingBottom();
    }

    @Override // p000.AbstractC0916mu
    /* renamed from: g */
    public final int mo63441g() {
        return this.f161089a.getPaddingBottom();
    }
    ...
    public final int mo63444j() {
        return this.f161089a.getPaddingTop();
    }
    ...
    public final int mo63445k() {
        AbstractC0935nm abstractC0935nm = this.f161089a;
        return (abstractC0935nm.f162613E - abstractC0935nm.getPaddingTop()) - this.f161089a.getPaddingBottom();
    }
    ...
    public final int mo63447m(View view) {
        this.f161089a.m63877bw(view, this.f161091c);
        return this.f161091c.top;
    }

    @Override // p000.AbstractC0916mu
    /* renamed from: n */
    public final void mo63448n(int i) {
        this.f161089a.mo23210aU(i);
    }
}
