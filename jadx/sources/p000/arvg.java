...
public final class arvg extends askd {
    public arvg(Context context, Looper looper, asjy asjyVar, asgw asgwVar, asgx asgxVar) {
        super(context, looper, 154, asjyVar, asgwVar, asgxVar);
    }
    ...
    public final /* synthetic */ IInterface mo27812b(IBinder iBinder) {
        ...
        if (queryLocalInterface instanceof arvh) {
            return (arvh) queryLocalInterface;
        }
        return new arvh(iBinder);
    }
