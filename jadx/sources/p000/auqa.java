...
public final class auqa implements auqb {

    /* renamed from: a */
    private final Throwable f67409a;

    public auqa(Throwable th) {
        this.f67409a = th;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof auqa) && C1131ut.m70384u(this.f67409a, ((auqa) obj).f67409a)) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "HttpTokenResetFailure(exception=" + this.f67409a + ")";
    }
}
