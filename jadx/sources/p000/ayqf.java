...
public class ayqf extends DialogInterfaceOnCancelListenerC0086bq implements ayoy {

    /* renamed from: aJ */
    public final ayox f76604aJ = new ayox();

    @Override // p000.ComponentCallbacksC0094by
    /* renamed from: P */
    public View mo2064P(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f76604aJ.m34683g(bundle);
    ...
    public final boolean mo18807aU(MenuItem menuItem) {
        return this.f76604aJ.m34702P(menuItem);
    }

    @Override // p000.ComponentCallbacksC0094by
    /* renamed from: aj */
    public final void mo21922aj(Bundle bundle) {
        this.f76604aJ.m34678a(bundle);
    ...
    public final void mo28502ak(int i, int i2, Intent intent) {
        this.f76604aJ.m34690D(i, i2, intent);
    }

    @Override // p000.ComponentCallbacksC0094by
    /* renamed from: al */
    public void mo20382al(Activity activity) {
        this.f76604aJ.m34679b(activity);
    ...
    public final void mo34389at(int i, String[] strArr, int[] iArr) {
        this.f76604aJ.m34694H(i, strArr, iArr);
    }
    ...
    public void mo10465av(View view, Bundle bundle) {
        this.f76604aJ.m34685j(view, bundle);
    }

    @Override // p000.ComponentCallbacksC0094by
    /* renamed from: ba */
    public final boolean mo34727ba() {
        if (!this.f76604aJ.m34706V()) {
            return false;
        }
        return true;
    }
