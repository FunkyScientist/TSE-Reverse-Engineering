...
public final class bwj implements ewo {

    /* renamed from: a */
    public static final bwj f121873a = new bwj();
    ...
    public final ewp mo14167e(ewr ewrVar, List list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(((ewm) list.get(i)).mo52325e(j));
        }
        mo45786eQ = ewrVar.mo45786eQ(gcj.m53693b(j), gcj.m53692a(j), bkcz.f114917a, new bwi(arrayList));
        return mo45786eQ;
    }
}
