...
public final class atcj {
    ...
    /* renamed from: c */
    static final boolean m29126c(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length != 1) {
            return false;
        }
        if (z) {
            return m29128e(packageInfo, f62939a, f62940b);
        }
        return m29128e(packageInfo, f62939a);
    }

    /* renamed from: d */
    private static byte[] m29127d(String str) {
        return str.getBytes(StandardCharsets.ISO_8859_1);
    }

    /* renamed from: e */
    private static final boolean m29128e(PackageInfo packageInfo, byte[]... bArr) {
    ...
    /* renamed from: b */
    public final boolean m29129b() {
        PackageInfo packageInfo;
        boolean z;
        try {
            packageInfo = asmb.m28664b(this.f62942d).m6098b("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfo = null;
        }
        if (packageInfo != null) {
            if (asgh.m28365e(this.f62942d)) {
                z = m29126c(packageInfo, true);
            } else {
                boolean m29126c = m29126c(packageInfo, false);
                if (m29126c || !m29126c(packageInfo, true)) {
                    z = m29126c;
                }
            }
            if (z) {
