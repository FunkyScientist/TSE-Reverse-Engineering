...
public final class bjza implements HostnameVerifier {

    /* renamed from: a */
    public static final bjza f114651a = new bjza();

    /* renamed from: b */
    private static final Pattern f114652b = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");

    private bjza() {
    }

    /* renamed from: a */
    private static List m44426a(X509Certificate x509Certificate, int i) {
        Integer num;
        String str;
    ...
    /* renamed from: b */
    private static final boolean m44427b(String str, String str2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:80:0x00ec, code lost:
        ...
        r1 = r3.f114647d;
        r7 = new java.lang.String(r8, r1, r3.f114648e - r1);
     */
    ...
    */
    public final boolean verify(java.lang.String r17, javax.net.ssl.SSLSession r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.bjza.verify(java.lang.String, javax.net.ssl.SSLSession):boolean");
    }
}
