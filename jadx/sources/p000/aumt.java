...
public final class aumt implements auii {

    /* renamed from: a */
    public final Throwable f67008a;

    public aumt(Throwable th) {
        this.f67008a = th;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof aumt) && C1131ut.m70384u(this.f67008a, ((aumt) obj).f67008a)) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "AuthTokenPermanentFailure(exception=" + this.f67008a + ")";
    }
}
