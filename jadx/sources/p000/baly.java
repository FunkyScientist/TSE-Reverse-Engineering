...
public final class baly {
    ...
    /* renamed from: a */
    public static final /* synthetic */ int f81156a = 0;

    /* renamed from: b */
    private static final bbxt f81157b;

    /* renamed from: c */
    private static final bbxt f81158c;

    static {
        balu.m36943b('\n');
        balu.m36944c(baju.f81049a);
        bakf.m36906k("\u0091\u0092‘’");
        bakf.m36906k("\u0093\u0094“”");
        ...
        new bakd(new bajw('A', 'F'), new bajw('a', 'f'));
        ...
        bain.m36808X(173, hashSet2);
        bain.m36809Y(1536, 1539, hashSet2);
        bain.m36808X(1757, hashSet2);
        bain.m36808X(1807, hashSet2);
        bain.m36809Y(6068, 6069, hashSet2);
        bain.m36809Y(8203, 8207, hashSet2);
        bain.m36809Y(8234, 8238, hashSet2);
        bain.m36809Y(8288, 8292, hashSet2);
        bain.m36809Y(8298, 8303, hashSet2);
        bain.m36808X(65279, hashSet2);
        bain.m36809Y(65529, 65531, hashSet2);
        bain.m36809Y(119155, 119162, hashSet2);
        bain.m36808X(917505, hashSet2);
        bain.m36809Y(917536, 917631, hashSet2);
        bain.m36808X(0, hashSet2);
        bain.m36808X(10, hashSet2);
        bain.m36808X(13, hashSet2);
        bain.m36809Y(8232, 8233, hashSet2);
        bain.m36808X(133, hashSet2);
        bain.m36808X(Character.codePointAt("'", 0), hashSet2);
        bain.m36808X(Character.codePointAt("\"", 0), hashSet2);
        bain.m36808X(Character.codePointAt("&", 0), hashSet2);
        bain.m36808X(Character.codePointAt("<", 0), hashSet2);
        bain.m36808X(Character.codePointAt(">", 0), hashSet2);
        bain.m36808X(Character.codePointAt("=", 0), hashSet2);
        bain.m36808X(Character.codePointAt("\\", 0), hashSet2);
        bbxt bbxtVar = new bbxt(hashSet2);
        f81157b = bbxtVar;
        HashSet hashSet3 = new HashSet();
        bain.m36808X(Character.codePointAt("\"", 0), hashSet3);
        bain.m36808X(Character.codePointAt("\\", 0), hashSet3);
        bain.m36809Y(0, 31, hashSet3);
        bbxt bbxtVar2 = new bbxt(hashSet3);
        f81158c = bbxtVar2;
        HashSet hashSet4 = new HashSet();
        bain.m36812aA(bbxtVar2, hashSet4);
        bain.m36812aA(bbxtVar, hashSet4);
        new bbxt(hashSet4);
    }

    /* renamed from: a */
    public static boolean m36969a(String str) {
        if (str != null && !bake.f81061b.mo36901f(str)) {
            return false;
        }
        return true;
    }
