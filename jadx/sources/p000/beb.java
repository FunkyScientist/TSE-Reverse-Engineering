...
public final class beb extends eck implements fay {

    /* renamed from: a */
    public float f94912a;

    /* renamed from: b */
    public float f94913b;

    /* renamed from: c */
    public boolean f94914c = true;

    public beb(float f, float f2) {
        this.f94912a = f;
        this.f94913b = f2;
    }
    ...
    public final ewp mo11077b(ewr ewrVar, ewm ewmVar, long j) {
        ...
        mo45786eQ = ewrVar.mo45786eQ(mo52325e.f138616a, mo52325e.f138617b, bkcz.f114917a, new bea(this, mo52325e, ewrVar));
        return mo45786eQ;
    }
