...
public final class cqv extends bkgu implements bkga {

    /* renamed from: a */
    final /* synthetic */ bkgb f134048a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public cqv(bkgb bkgbVar) {
        super(2);
        this.f134048a = bkgbVar;
    }
    ...
    public final /* bridge */ /* synthetic */ Object mo9860a(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && dmxVar.mo50711L()) {
            ...
            bai baiVar = bat.f81490b;
            int i = ebu.f137409a;
            bkgb bkgbVar = this.f134048a;
            ebt ebtVar = ebr.f137404k;
            ech echVar = ecl.f137440e;
            ewo m39377a = bes.m39377a(baiVar, ebtVar, dmxVar, 54);
