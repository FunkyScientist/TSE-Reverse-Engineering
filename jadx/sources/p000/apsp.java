...
public class apsp extends yff implements biao {

    /* renamed from: q */
    private biai f55336q;

    /* renamed from: r */
    private volatile bhzt f55337r;

    /* renamed from: s */
    private final Object f55338s = new Object();

    /* renamed from: p */
    public boolean f55335p = false;

    public apsp() {
        m66576jN(new C0197fc((ActivityC0198fd) this, 14));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getApplication() instanceof bian) {
            ...
            this.f55336q = m40965a;
            if (m40965a.m40974a()) {
                this.f55336q.f109784a = mo36704V();
            }
        }
    }
    ...
    public final bhzt mo20378b() {
        if (this.f55337r == null) {
            synchronized (this.f55338s) {
                if (this.f55337r == null) {
                    this.f55337r = new bhzt(this);
                }
            }
        }
        return this.f55337r;
