...
final class cuv extends bkgu implements bkga {

    /* renamed from: a */
    final /* synthetic */ float f134541a;

    /* renamed from: b */
    final /* synthetic */ bkga f134542b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public cuv(float f, bkga bkgaVar) {
        super(2);
        this.f134541a = f;
        this.f134542b = bkgaVar;
    }
    ...
    public final /* bridge */ /* synthetic */ Object mo9860a(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && dmxVar.mo50711L()) {
            ...
            ecl m39397a = bey.m39397a(ecl.f137440e, this.f134541a, 56.0f);
            int i = ebu.f137409a;
            bkga bkgaVar = this.f134542b;
            ewo m37570a = bbb.m37570a(ebr.f137398e, false);
            int mo50714a = dmxVar.mo50714a();
            dns mo50717d = dmxVar.mo50717d();
            ecl m51435b = ecf.m51435b(dmxVar, m39397a);
            int i2 = ezt.f138732a;
