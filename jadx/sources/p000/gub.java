...
public final class gub extends InputConnectionWrapper {

    /* renamed from: a */
    final /* synthetic */ usl f142241a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public gub(InputConnection inputConnection, usl uslVar) {
        super(inputConnection, false);
        this.f142241a = uslVar;
    }
        ...
        if (bundle != null) {
            ...
            try {
                ...
                if (uri != null && clipDescription != null) {
                    r3 = uslVar.m70272U(new kni(uri, clipDescription, uri2), i, bundle2);
                }
                if (r5 != 0) {
                    r5.send(r3, null);
                }
