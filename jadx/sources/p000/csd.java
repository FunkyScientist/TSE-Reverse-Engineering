...
public final class csd extends bkgu implements bkga {

    /* renamed from: a */
    final /* synthetic */ bkgb f134200a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public csd(bkgb bkgbVar) {
        super(2);
        this.f134200a = bkgbVar;
    }
