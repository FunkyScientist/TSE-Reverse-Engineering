...
public final class aeih implements aeix {

    /* renamed from: a */
    private static final aefp f20949a = aefp.AUTO_ENHANCE;
    ...
    public final boolean mo14911e(aecd aecdVar) {
        if (aecdVar.mo14457x().mo14721s() && ((aefp) aecdVar.mo14458y(aefq.f20588a)).equals(f20949a)) {
            return true;
        }
        return false;
    }
    ...
    public final /* synthetic */ PipelineParams mo14916m(aecd aecdVar, aegv aegvVar) {
        ...
        aefq.f20588a.mo14614e(mo14706d, f20949a);
        return mo14706d;
    }
    ...
    public final void mo14917n(aecd aecdVar) {
        ...
        aedfVar.m14556H(aefq.f20588a, f20949a);
        aecdVar.mo14459z();
    }
}
