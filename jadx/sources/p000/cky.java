...
final class cky extends bkgu implements bkgb {

    /* renamed from: a */
    final /* synthetic */ ckp f123004a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public cky(ckp ckpVar) {
        super(3);
        this.f123004a = ckpVar;
    }
    ...
    public final /* synthetic */ Object mo10652a(Object obj, Object obj2, Object obj3) {
        ...
        boolean mo50708I = dmxVar.mo50708I(this.f123004a);
        ckp ckpVar = this.f123004a;
        Object mo50721h2 = dmxVar.mo50721h();
        if (mo50708I || mo50721h2 == dmw.f136584a) {
            mo50721h2 = new cku(ckpVar, dppVar);
        ...
        if (mo50706G || mo50721h3 == dmw.f136584a) {
            mo50721h3 = new ckx(gcmVar, dppVar);
