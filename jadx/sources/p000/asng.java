...
public final class asng {
    ...
    /* renamed from: a */
    private static ClassLoader f62130a;

    /* renamed from: b */
    private static Thread f62131b;
    ...
    */
    public static synchronized java.lang.ClassLoader m28708a() {
        /*
            java.lang.Class<asng> r0 = p000.asng.class
            monitor-enter(r0)
            java.lang.ClassLoader r1 = p000.asng.f62130a     // Catch: java.lang.Throwable -> La5
            if (r1 != 0) goto La1
            java.lang.Thread r1 = p000.asng.f62131b     // Catch: java.lang.Throwable -> La5
            r2 = 0
            if (r1 != 0) goto L8d
        ...
        L67:
            if (r5 != 0) goto L84
            asnf r1 = new asnf     // Catch: java.lang.SecurityException -> L79 java.lang.Throwable -> L7c
        ...
        L84:
            ...
            r1 = r5
        L86:
            p000.asng.f62131b = r1     // Catch: java.lang.Throwable -> La5
            if (r1 != 0) goto L8d
            goto L9c
        L8b:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L7c
        ...
        L8d:
            ...
            java.lang.Thread r3 = p000.asng.f62131b     // Catch: java.lang.Throwable -> L95 java.lang.SecurityException -> L97
        ...
        L9c:
            p000.asng.f62130a = r2     // Catch: java.lang.Throwable -> La5
            goto La1
        L9f:
            monitor-exit(r1)     // Catch: java.lang.Throwable -> L95
        ...
        La5:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.asng.m28708a():java.lang.ClassLoader");
    }
}
