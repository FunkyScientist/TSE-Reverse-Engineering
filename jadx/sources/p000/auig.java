...
public final class auig implements auie {

    /* renamed from: a */
    private final Throwable f66558a;

    public auig(Throwable th) {
        this.f66558a = th;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof auig) && C1131ut.m70384u(this.f66558a, ((auig) obj).f66558a)) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "GenericTransientFailure(exception=" + this.f66558a + ")";
    }
}
