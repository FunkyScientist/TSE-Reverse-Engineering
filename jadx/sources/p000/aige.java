...
final class aige implements aios {

    /* renamed from: a */
    private static final ContentId f32069a = new AutoValue_ContentId(ahia.PHOTOBOOK, ainl.ORDER);

    /* renamed from: b */
    private final Context f32070b;

    /* renamed from: c */
    private final aiok f32071c;

    public aige(Context context) {
        this.f32070b = context;
        this.f32071c = new aipd(context);
    }
    ...
    public final Uri mo18532d(int i) {
        return _2001.m3201q(2, i, ahia.PHOTOBOOK);
    }
    ...
    public final aioo mo18535g(ComponentCallbacksC0094by componentCallbacksC0094by, aypb aypbVar) {
        return new ainx(aypbVar, f32069a);
    }
    ...
    public final List mo18537i(int i, boolean z, int i2, ahsn ahsnVar) {
        batz m3427b = ((_2112) aylw.m34567e(this.f32070b, _2112.class)).m3427b(ahia.PHOTOBOOK, i, i2);
        ArrayList arrayList = new ArrayList(((bbbl) m3427b).f81877c);
        arrayList.addAll(new ains(this.f32070b, i, new aigd(this.f32070b, z, 0)).mo9346a(m3427b));
        return arrayList;
    }
}
