...
public final class C1113ub {
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public static void m69641a(BiometricPrompt.Builder builder, int i) {
        tu$$ExternalSyntheticApiModelOutline0.m69447m(builder, i);
    }

    /* renamed from: b */
    public static final float m69642b(gvj gvjVar) {
        return ((C1136uy) gvjVar.f142386a).f182142b;
    }

    /* renamed from: c */
    public static final float m69643c(gvj gvjVar) {
        return ((C1136uy) gvjVar.f142386a).f182141a;
    }

    /* renamed from: d */
    public static final void m69644d(gvj gvjVar) {
        if (!gvjVar.m54922c()) {
            gvjVar.m54920a(0, 0, 0, 0);
            return;
        }
        float m69642b = m69642b(gvjVar);
        float m69643c = m69643c(gvjVar);
        int ceil = (int) Math.ceil(C1137uz.m70680a(m69642b, m69643c, gvjVar.m54921b()));
        int ceil2 = (int) Math.ceil(C1137uz.m70681b(m69642b, m69643c, gvjVar.m54921b()));
        gvjVar.m54920a(ceil, ceil2, ceil, ceil2);
    }

    /* renamed from: e */
    public static /* synthetic */ List m69645e(Object[] objArr) {
    ...
    /* renamed from: f */
    public static Path m69646f(String str) {
        Path path = new Path();
        try {
            m69647g(m69649i(str), path);
            return path;
    ...
    /* renamed from: g */
    public static void m69647g(goh[] gohVarArr, Path path) {
        int i;
        int i2;
        float[] fArr;
        char c;
        ...
        float f7;
        float f8;
        goh[] gohVarArr2 = gohVarArr;
        float[] fArr2 = new float[6];
        int length = gohVarArr2.length;
        char c2 = 0;
        int i5 = 0;
        char c3 = 'm';
        while (i5 < length) {
            goh gohVar2 = gohVarArr2[i5];
            char c4 = gohVar2.f141911a;
            float[] fArr3 = gohVar2.f141912b;
            float f9 = fArr2[c2];
            float f10 = fArr2[1];
            float f11 = fArr2[2];
            float f12 = fArr2[3];
            ...
            while (i6 < fArr3.length) {
                if (c4 != 'A') {
                            ...
                            if (c4 != 'Q') {
                                if (c4 != 'V') {
                                    if (c4 != 'a') {
                                        ...
                                        i4 = length;
                                        gohVar = gohVar2;
                                        goh.m54377a(path, f17, f18, f25, f26, f27, f28, f29, z3, z4);
                                        f17 += fArr[i25];
                                        f18 += fArr[i24];
                                    }
                                } else {
                    ...
                    goh.m54377a(path, f17, f18, f32, f33, f34, f35, f36, z, z2);
                    f17 = fArr[i35];
                    f18 = fArr[i34];
                }
                f11 = f17;
            ...
            c2 = 0;
            length = length;
            gohVarArr2 = gohVarArr;
        }
    }

    /* renamed from: h */
    public static boolean m69648h(goh[] gohVarArr, goh[] gohVarArr2) {
        if (gohVarArr != null && gohVarArr2 != null) {
            if (gohVarArr.length == gohVarArr2.length) {
                for (int i = 0; i < gohVarArr.length; i++) {
                    goh gohVar = gohVarArr[i];
                    char c = gohVar.f141911a;
                    goh gohVar2 = gohVarArr2[i];
                    if (c != gohVar2.f141911a || gohVar.f141912b.length != gohVar2.f141912b.length) {
                        return false;
                    }
                }
                return true;
    ...
    */
    public static p000.goh[] m69649i(java.lang.String r17) {
        /*
            Method dump skipped, instructions count: 258
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C1113ub.m69649i(java.lang.String):goh[]");
    }

    /* renamed from: j */
    public static goh[] m69650j(goh[] gohVarArr) {
        goh[] gohVarArr2 = new goh[gohVarArr.length];
        for (int i = 0; i < gohVarArr.length; i++) {
            gohVarArr2[i] = new goh(gohVarArr[i]);
        }
        return gohVarArr2;
    }

    /* renamed from: k */
    public static float[] m69651k(float[] fArr, int i) {
        if (i >= 0) {
    ...
    /* renamed from: l */
    private static void m69652l(ArrayList arrayList, char c, float[] fArr) {
        arrayList.add(new goh(c, fArr));
    }
}
