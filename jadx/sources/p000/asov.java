...
public final class asov extends askd {
    public asov(Context context, Looper looper, asjy asjyVar, asia asiaVar, asiy asiyVar) {
        super(context, looper, 257, asjyVar, asiaVar, asiyVar);
    }
    ...
    public final /* synthetic */ IInterface mo27812b(IBinder iBinder) {
        ...
        if (queryLocalInterface instanceof asol) {
            return (asol) queryLocalInterface;
        }
        return new asol(iBinder);
    }
