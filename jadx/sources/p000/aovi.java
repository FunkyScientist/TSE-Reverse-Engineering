...
public final class aovi implements _2766 {

    /* renamed from: a */
    private static final FeaturesRequest f53236a;
    ...
    public final Optional mo5505b(Context context, int i, _1846 _1846) {
        ...
        if (_180 != null && _180.f2214a && _151 != null && _151.m1527b() && _155 != null && _155.mo1621v()) {
            return Optional.m59252of(new SuggestedAction(((DedupKey) _151.f1074a.get()).mo47325a(), _2772.m5557i(context, aoti.MARKUP), aoti.MARKUP, aoth.PENDING, aotg.CLIENT));
        }
        return Optional.empty();
    }
}
