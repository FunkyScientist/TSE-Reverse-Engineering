...
public class PreferenceImageView extends ImageView {
    ...
    */
    ...
    public PreferenceImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f48538a = Integer.MAX_VALUE;
        this.f48539b = Integer.MAX_VALUE;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, jkm.f151989h, i, 0);
