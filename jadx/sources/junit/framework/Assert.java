...
public class Assert {
    ...
    public static void assertNull(Object obj) {
        if (obj != null) {
            assertNull("Expected: <null> but was: ".concat(String.valueOf(obj.toString())), obj);
        }
    }
    ...
    public static void failNotSame(String str, Object obj, Object obj2) {
        ...
        fail(str2 + "expected same:<" + String.valueOf(obj) + "> was not:<" + String.valueOf(obj2) + ">");
    }
    ...
    public static void failSame(String str) {
        ...
        fail(str2.concat("expected not same"));
    }
